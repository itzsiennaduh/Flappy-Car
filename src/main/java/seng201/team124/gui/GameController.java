...
public class GameController {
    ...
    private Consumer<Double> speedListener;
    private Runnable onFinish;
    private Runnable onCrash;
    ...
    /**
     * Build raw 3D world; MainController will wrap this in a SubScene.
     */

    public void setSpeedListener(Consumer<Double> listener) {
    ...
    public void setOnCrash(Runnable r) {
        this.onCrash = r;
    }
...
// if you want to adjust track separately, do it on modelGroup only
    ...
    private void update(double deltaTime) {
        ...
        if (speedListener != null) {
            speedListener.accept(velocity * 3.6);
        }
