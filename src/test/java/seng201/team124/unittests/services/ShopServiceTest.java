...
public class ShopServiceTest {
    ...
    @BeforeEach
    void setUp() {
        vehicle = new Vehicle("Car1", "Fast car", 200, 10, 70, 80, 5, 50000, 50, 60, "ModelX", "path");
        ...
        shop = new Shop();
        allPossibleVehicles = List.of(vehicle, new Vehicle("Car2", "Luxury car", 300, 15, 80, 85, 6, 70000, 60, 70, "ModelY", "path"));
    ...
    void purchaseVehicleMaxVehiclesReached() {
        for (int i = 0; i < 5; i++) {
            player.addVehicle(new Vehicle("Car" + i, "Sample car", 200, 10, 70, 80, 5, 50000, 50, 60, "Model" + i, "path"));
        }
        String result = shopService.purchaseVehicle(vehicle);
